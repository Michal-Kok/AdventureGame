...
namespace AdventureGame
{
    public partial class AdventureGame : Form
    {
        ...
        public AdventureGame()
        {
            ...
            _player.Inventory.Add(new InventioryItem(World.ItemByID(World.ITEM_ID_RUSTY_SWORD), 1));
        ...
        private void MoveTo(Location newLocation)
        {
           ...
           if(!_player.HasRequiredItemToEnterThisLocation(newLocation))
                ...
                if (playerAlreadyHasQuest)
                {
                    ...
                    if (!playerAlreadyCompletedQuest)
                    {
                        ...
                        foreach (QuestCompletionItem qci in newLocation.QuestAvailableHere.QuestCompletionItems)
                        {
                            ...
                            foreach (InventioryItem ii in _player.Inventory)
                            {
                        ...
                        if (playerHasAllItemsToCompleteQuest)
                        {
                            ...
                            rtbMessages.Text += newLocation.QuestAvailableHere.RewardExperiencePoint.ToString() + " experience points" + Environment.NewLine;
                            rtbMessages.Text += newLocation.QuestAvailableHere.RewardGold.ToString() + " gold" + Environment.NewLine;
                            rtbMessages.Text += newLocation.QuestAvailableHere.RewardItem.Name + Environment.NewLine;
                            rtbMessages.Text += Environment.NewLine;

                            _player.ExperiencePoints += newLocation.QuestAvailableHere.RewardExperiencePoint;
                            ...
                            {
                                _player.Inventory.Add(new InventioryItem(newLocation.QuestAvailableHere.RewardItem, 1));
                            }
            ...
            if (newLocation.MonsterLivingHere != null)
            {
                ...
                _currentMonster = new Monster(standardMonster.ID, standardMonster.Name, standardMonster.MaximumDemage,
            ...
            foreach (InventioryItem inventoryItem in _player.Inventory)
            {
